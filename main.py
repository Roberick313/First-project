...
def main():
    ...
    to show the Options and take an input for
    each choice to return the result of that."""
    ...
    \rThis program contain some functions
    ...
    print(welcome)
    time.sleep(1.5)
    info_command = F"""\nType one of the below words in any input to make it.
    \r1.end : is for, to shutdown the program.(CTRL+C) will do the same.
    \r2.back : is to take a step back.
    """
            ...
            if account_checker:
                ...
                while True:
                    ...
                    # has been chosen...
                        ...
                        \rplease enter the number of selected function or
                        \rthe full name or the first 3 character of the function name
